...
namespace DFramework.Infrastructure.Persistence.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Map = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    IconClass = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true),
                    ParentId = table.Column<int>(type: "int", nullable: true),
                    OrderIndex = table.Column<short>(type: "smallint", nullable: true, defaultValueSql: "((0))"),
                    IsHeader = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))"),
                    CreatedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SettingKey = table.Column<string>(type: "varchar(200)", unicode: false, maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LanguageResources_Languages",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePermissionAccess", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RolePermissionAccess_Access",
                        column: x => x.AccessId,
                        principalTable: "Access",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RolePermissionAccess_RolePermissions",
                        column: x => x.RolPermissionId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePermissionAccess_AccessId",
                table: "RolePermissionAccess",
                column: "AccessId");

            migrationBuilder.CreateIndex(
                name: "IX_RolePermissionAccess_RolPermissionId",
                table: "RolePermissionAccess",
                column: "RolPermissionId");
